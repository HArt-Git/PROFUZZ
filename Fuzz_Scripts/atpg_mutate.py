...
def b11(input_bin):
  ...
  for gh in range(len(bin_list)):
    ...
    file1 = open('atpg_mutated_seeds.txt', 'a')
...
def arith16(input_bin):
    ...
    for x in range(0, len(input_bin) - 15):  # Ensure 16-bit segments exist
        ...
        with open('atpg_mutated_seeds.txt', 'a') as file1:
            file1.writelines(mutated_seq + '\n')
...
def bf(input_bin):
    """Flips all bits in a binary sequence and appends the result to a file."""
    bin_list = list(input_bin)
    for i in range(len(bin_list)):
        bin_list[i] = '0' if bin_list[i] == '1' else '1'
    mutated_binary = ''.join(bin_list)
    with open('atpg_mutated_seeds.txt', 'a') as file1:
        file1.write(mutated_binary + '\n')
    return ()


def deploy_mutation(input_file):
  count = 0
  ...
  with open(input_file, 'r') as file1:
    for line in file1:
      ...
      if line:
        ...
        #  possible_mutattions=[b16,arith16,b88,i8,i16,arith8,b11,b21,b41,ndb1]
          possible_mutattions=[bf,b11,b21,b41,b88,b16,i8,i16,arith16,arith8,ndb1]
        elif (bit_length >=32 ):
          print("all")
          #possible_mutattions=[b11,b21,b41,b88,b16,b32,arith8,ndb1,i8,i16,i32]
          possible_mutattions=[bf,b11,b21,b41,b16,b32,arith8,arith16,arith32,ndb1,i8,i16,i32]
        else:
